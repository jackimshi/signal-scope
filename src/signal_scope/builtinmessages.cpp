...
//#include "lcmtypes/pronto/atlas_command_t.hpp"
//#include "lcmtypes/pronto/atlas_foot_pos_est_t.hpp"
...
//#include "lcmtypes/pronto/controller_debug_t.hpp"
...
define_array_handler(SixAxisForceTorqueTypeForceHandler, pronto::six_axis_force_torque_t, force, createIndexList(3));
define_array_handler(SixAxisForceTorqueTypeMomentHandler, pronto::six_axis_force_torque_t, moment, createIndexList(3));

// atlas_foot_pos_est_t
//define_array_handler(AtlasFootPosEstLeftPositionHandler, pronto::atlas_foot_pos_est_t, left_position, createIndexList(3));
//define_array_handler(AtlasFootPosEstRightPositionHandler, pronto::atlas_foot_pos_est_t, right_position, createIndexList(3));
...
// controller_debug_t
/*
define_field_handler(ControllerDebugRightFoot, pronto::controller_debug_t, r_foot_contact);
define_field_handler(ControllerDebugLeftFoot, pronto::controller_debug_t, l_foot_contact);
define_field_handler(ControllerDebugSolverInfo, pronto::controller_debug_t, info);
define_array_handler(ControllerDebugQddDes, pronto::controller_debug_t, qddot_des, createIndexList(34));
define_array_handler(ControllerDebugU, pronto::controller_debug_t, u, createIndexList(28));
define_array_handler(ControllerDebugAlpha, pronto::controller_debug_t, alpha, createIndexList(90));
define_array_handler(ControllerDebugZMPerr, pronto::controller_debug_t, zmp_err, createIndexList(2));
*/
/*
define_field_array_handler(AtlasControlJointsPositionHandler, pronto::atlas_control_data_t, joints, position, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsVelocityHandler, pronto::atlas_control_data_t, joints, velocity, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsEffortHandler, pronto::atlas_control_data_t, joints, effort, JointNames::jointNames());

define_field_array_handler(AtlasControlJointsKQPHandler, pronto::atlas_control_data_t, joints, k_q_p, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsKQIHandler, pronto::atlas_control_data_t, joints, k_q_i, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsKQDPHandler, pronto::atlas_control_data_t, joints, k_qd_p, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsKFPHandler, pronto::atlas_control_data_t, joints, k_f_p, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsFFQDHandler, pronto::atlas_control_data_t, joints, ff_qd, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsFFQDDPHandler, pronto::atlas_control_data_t, joints, ff_qd_d, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsFFFDHandler, pronto::atlas_control_data_t, joints, ff_f_d, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsFFConstHandler, pronto::atlas_control_data_t, joints, ff_const, JointNames::jointNames());
define_field_array_handler(AtlasControlJointsKEffortHandler, pronto::atlas_control_data_t, joints, k_effort, JointNames::jointNames());
define_field_field_handler(AtlasControlJointsDesiredControllerPeriodHandler, pronto::atlas_control_data_t, joints, desired_controller_period_ms);
*/

/*
define_array_handler(AtlasControlJointsPositionHandler, pronto::atlas_command_t, position, JointNames::jointNames());
define_array_handler(AtlasControlJointsVelocityHandler, pronto::atlas_command_t, velocity, JointNames::jointNames());
define_array_handler(AtlasControlJointsEffortHandler, pronto::atlas_command_t, effort, JointNames::jointNames());

define_array_handler(AtlasControlJointsKQPHandler, pronto::atlas_command_t, k_q_p, JointNames::jointNames());
define_array_handler(AtlasControlJointsKQIHandler, pronto::atlas_command_t, k_q_i, JointNames::jointNames());
define_array_handler(AtlasControlJointsKQDPHandler, pronto::atlas_command_t, k_qd_p, JointNames::jointNames());
define_array_handler(AtlasControlJointsKFPHandler, pronto::atlas_command_t, k_f_p, JointNames::jointNames());
define_array_handler(AtlasControlJointsFFQDHandler, pronto::atlas_command_t, ff_qd, JointNames::jointNames());
define_array_handler(AtlasControlJointsFFQDDPHandler, pronto::atlas_command_t, ff_qd_d, JointNames::jointNames());
define_array_handler(AtlasControlJointsFFFDHandler, pronto::atlas_command_t, ff_f_d, JointNames::jointNames());
define_array_handler(AtlasControlJointsFFConstHandler, pronto::atlas_command_t, ff_const, JointNames::jointNames());
define_array_handler(AtlasControlJointsKEffortHandler, pronto::atlas_command_t, k_effort, JointNames::jointNames());
define_field_handler(AtlasControlJointsDesiredControllerPeriodHandler, pronto::atlas_command_t, desired_controller_period_ms);
*/
